...
return [
    ...
    'account_profile' => [[], ['_controller' => 'App\\Controller\\AccountController::editProfile'], [], [['text', '/mon-profil']], [], [], []],
    ...
    'checkout' => [['reference'], ['_controller' => 'App\\Controller\\PaymentController::checkout'], [], [['variable', '/', '[^/]++', 'reference', true], ['text', '/commande/checkout']], [], [], []],
    'payment_success' => [['reference'], ['_controller' => 'App\\Controller\\PaymentController::paymentSuccess'], [], [['variable', '/', '[^/]++', 'reference', true], ['text', '/commande/valide/paypal']], [], [], []],
    'payment_fail' => [['reference'], ['_controller' => 'App\\Controller\\PaymentController::paymentFail'], [], [['variable', '/', '[^/]++', 'reference', true], ['text', '/commande/echec/paypal']], [], [], []],
